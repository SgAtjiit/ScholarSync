  ...
  if (assignments.length === 0) {
    return (
      <EmptyState
        ...
        description={user?.hasClassroomConnected 
          ? "Try syncing your Google Classroom or changing the filter to see assignments."
          : "Try creating a manual assignment or sync your Google Classroom to see assignments."
        }
        variant="default"
