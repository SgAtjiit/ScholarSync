import { Brain, HelpCircle, Layers, PenTool, Loader2, Check, Sparkles } from 'lucide-react';
...
const AIAssistant = ({ activeMode, onGenerate, generating, hasSolution, disabled }) => {
  const modes = [
    ...
    { id: 'tutor', label: 'AI Socratic Tutor', icon: Sparkles, description: 'Step-by-step guidance' },
  ];
