 ...
 */
export const fetchFileAsArrayBuffer = async (fileId, userId, serverUrl, onProgress, isManualFile = false) => {
    ...
    const downloadUrl = `${serverUrl}/api/stream/download/${fileId}?userId=${userId}${isManualFile ? '&isManual=true' : ''}`;
