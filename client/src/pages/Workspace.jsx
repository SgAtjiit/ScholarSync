...
const Workspace = () => {
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 px-2 sm:px-4 pb-4 h-[calc(100vh-5rem)] overflow-hidden">
      ...
      <div className="lg:w-[360px] xl:w-[420px] shrink-0 flex flex-col gap-4 h-full min-h-0 overflow-y-auto custom-scrollbar pr-1 pb-4">
            ...
            <GlassCard className="flex flex-col gap-4 shrink-0" hoverEffect={false}>
              <div>
                ...
                <p className="text-sm text-zinc-400 mt-2">{assignment?.description || "No description provided."}</p>
              </div>
          ...
          {allDocMaterials.length > 0 && (
            <GlassCard hoverEffect={false} className="shrink-0">
              ...
              {/* FIX 4: Internal Scroll for Documents list (matching your wireframe) */}
      ...
      <div className="flex-1 flex flex-col h-full min-h-0 overflow-hidden">
        <div className="flex-1 flex flex-col bg-zinc-900/60 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl overflow-hidden min-h-0">
          ...
          <div className="flex items-center gap-2 p-3 border-b border-white/10 bg-zinc-900/50 shrink-0">
            ...
            <button onClick={() => setActiveTab('chat')} className={`px-4 py-2 rounded-md transition-all text-sm font-medium flex items-center gap-2 ${activeTab === 'chat' ? 'bg-indigo-600 text-white' : 'text-zinc-300 hover:bg-zinc-800'}`}>
